...
const PhotographerList = ({ photographerList, navigation }) => {
  ...
  const handleToDetail = (paramValue) => {
    navigation.navigate("PhotographerProfile", {paramValue})
  }
  return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.wrapcard}>
          {photographerList.map((photographer) => (
            <TouchableOpacity key={photographer?.id} style={styles.rowContainer} onPress={() => handleToDetail(photographer?.id)}>
              <Avatar
