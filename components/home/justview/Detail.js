        ...
        <View style={styles.wrapinfo}>
          <View styles={styles.wraptitle_creator}>
            ...
            <View style={styles.creator}>
              ...
              />
              <Text style={styles.namePhoto}>Bởi {item.name}</Text>
            </View>
          </View>
          <Text style={styles.price}>1.000.000đ</Text>
        </View>

        <ScrollView horizontal contentContainerStyle={{ flexDirection: 'row' }} 
        showsHorizontalScrollIndicator={false}>
      {data.map((item) => (
        <View key={item.id} style={{ paddingLeft:17 }}>
          <Image source={item.imageSource} style={{ width: 122, height: 69 , borderRadius:7 }} />
        </View>
      ))}
    </ScrollView>
        ...
        <View style={styles.wrapdescription}>
          ...
          <Text style={styles.description}>
            Những năm tháng học sinh kết thúc cũng là lúc chúng ta phải từng
            bước trở thành người lớn, vì vậy một bộ ảnh tốt nghiệp đánh dấu cột
            mốc đáng nhớ này sẽ là một kỉ niệm đáng giá cho bạn, để sau này khi
            nhìn lại bạn sẽ mỉm cười nhớ lại về một thời đã qua.
          </Text>
        ...
        <View style={styles.InfoCamContainer}>
          <View style={styles.wrapInfoCam}>
            <View style= {styles.wrapIcon_name}>
              ...
              <Text style={styles.nameCam}>Canon700D</Text>
            </View>
            <View style= {styles.wrapIcon_name}>
              <View style={styles.backgroundimgcam}>
                <Image
